...
import moonPhase from './moon.json';
...
Mock.mock('/astronomy/sun', {
    ...
    fxLink: "http://hfx.link/2ax1",
    sunrise: "2021-12-13T06:58+08:00",
    sunset: "2021-12-13T17:57+08:00",
    refer: {
        sources: [
            "qweather.com"
        ],
...
Mock.mock('/astronomy/moon', {
    ...
    fxLink: "http://hfx.link/2ax1",
    moonrise: "2021-12-13T08:25+08:00",
    moonset: "2021-12-13T21:42+08:00",
    moonPhase: moonPhase,
    refer: {
        sources: [
            "QWeather"
